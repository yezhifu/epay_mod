...
<div id="pay0" class="api_block">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>签名算法<a href="https://opendocs.alipay.com/open/common/104741" target="_blank" style="color:#4585d2">点此查看</a>
            </td>
        </tr>
        <tr>
            <td>签名类型</td>
...
<div id="pay1" class="api_block">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>String</td>
            <td>pc</td>
            <td>根据当前用户浏览器的UA判断，<br/>传入用户所使用的浏览器<br/>或设备类型，默认为pc<br/><a href="#pay5"
                                                                                                      style="color:#4585d2">设备类型列表</a>
            </td>
        </tr>
        <tr>
            <td>业务扩展参数</td>
...
<div id="pay2" class="api_block">
    ...
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <td>String</td>
            <td>202cb962ac59075b964b07152d234b70</td>
            <td>签名算法与<a href="https://doc.open.alipay.com/docs/doc.htm?treeId=62&articleId=104741&docType=1"
...
<div id="pay3" class="api_block">
    ...
    <p>
        ...
        再将拼接好的请求字符串与平台生成的Key进行MD5加密得出sign签名参数 <code>md5 ( a=b&amp;c=d&amp;e=f + KEY )</code>
...
<div id="sdkwhmcs" class="api_block">
    <h3>
        WHMCS插件
    </h3>
    <blockquote>
        <a href="./assets/files/WHMCSSDK.zip" style="color:blue">WHMCSSDK.zip</a><br/>
        SDK版本：V1.2
    </blockquote>
</div>