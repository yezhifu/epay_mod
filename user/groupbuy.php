        ...
        <div class="wrapper-md control">
            ...
            <div class="row" id="infoFrame" style="display:none;">
                <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 center-block" style="float: none;">
                    <button class="btn btn-default btn-block" onclick="back()"><i class="fa fa-reply"></i>&nbsp;返回列表
                    </button>
                    <div class="panel panel-default">
                        <div class="panel-heading font-bold">
                            <i class="fa fa-shopping-cart"></i>&nbsp;购买会员
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal devform">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" type="text" name="group_expire" value=""
                                               readonly="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="radio">
                                            ...
                                            <?php foreach ($paytypem as $row) { ?>
                                                <?php if ($row['id'] != 7) { ?>
                                                    <label class="i-checks"><input type="radio" name="type"
                                                                                   value="<?php echo $row['id'] ?>"
                                                                                   rate="<?php echo $row['rate'] ?>"><i></i><?php echo $row['showname'] ?>
                                                    </label>&nbsp;
                                                <?php } ?>
                                            <?php } ?>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-8"><input type="button" id="submit"
                                                                                 value="立即购买"
