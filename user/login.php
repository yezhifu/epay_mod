...
<div class="form-group">
    ...
    <?php if($conf['reg_open']==0){ ?>
	    <a href="tg://resolve?domain=oldwebsietmaster" target="_blank" class="btn btn-danger btn-rounded" style="float:right;"><i class="fa fa-user-plus"></i>&nbsp;开户联系</a>
    <?php }else{ ?>
        <a href="reg.php" class="btn btn-danger btn-rounded" style="float:right;"><i class="fa fa-user-plus"></i>&nbsp;注册商户</a>
    <?php } ?>
</div>
