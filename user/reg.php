...
if($conf['reg_open']==0)sysmsg('暂未开放自主注册，<a href="tg://resolve?domain=oldwebsietmaster" target="_blank" class="btn btn-danger btn-rounded"><i class="fa fa-user-plus"></i>&nbsp;开户请联系@oldwebsietmaster</a>');
